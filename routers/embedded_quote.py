...
def embedded_quote(payload: EmbeddedQuoteRequest, _: None = Depends(verify_token)):
    ...
    # return quote id (keep shape consistent with existing rate_request)
    return {"quote_id": rate_resp.get("quote_id")}
